...
class ProtoDecoder(Decoder):
    deframer = {
        ...
        utils.ProtoDeframer.BINAR2: satellites.components.deframers.binar2_deframer,
        ...
        utils.ProtoDeframer.OPENLST: satellites.components.deframers.openlst_deframer,
        utils.ProtoDeframer.OPS_SAT: satellites.components.deframers.ops_sat_deframer,
        utils.ProtoDeframer.QUBIK: satellites.components.deframers.qubik_deframer,
